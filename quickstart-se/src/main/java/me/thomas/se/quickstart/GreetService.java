...
public class GreetService implements Service {
    ...
    public void update(Routing.Rules rules) {
        rules.get("/", this::checkUrlHandler);
    }
     ...
     * @param response the server response
     */
    private void checkUrlHandler(ServerRequest request, ServerResponse response) {
        String url = request.queryParams().first("url").get();
        sendResponse(response, "Hello world " + url);
    }
